<template>
  <div style="padding-top: 16px;">
    ...
    <g-layout style="color: white; margin-bottom:50px;">
      <g-header style="height: 50px; padding: 10px; background:#999999;">
        header
      </g-header>
      <g-content style="height: 100px; width:100%; padding:10px; background:#666;">
        content
      </g-content>
      <g-footer style="height: 50px; padding:10px;background:#999999;">
        footer
      </g-footer>
    </g-layout>
